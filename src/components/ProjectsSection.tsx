      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to unfold each project card. Six end-to-end systems across NLP, computer vision, and full-stack AI.
          </p>
        </motion.div>
        ...
        >
          {projects.map((project) => (
            <ScrollStackItem key={project.title}>
              <div className="relative w-full rounded-2xl border border-[#8C6D4F]/50 bg-[#0E0C0A] p-6 sm:p-8 lg:p-12 shadow-[0_25px_70px_rgba(0,0,0,0.98)] group overflow-hidden transition-colors duration-500 hover:border-[#D4AF37]">
                  ...
                  <div className="lg:col-span-7 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center space-x-3 mb-4">
                        <span className="text-xs font-mono font-bold text-[#D4AF37]">{project.number} //</span>
                      ...
                      <h3
                        className="text-2xl sm:text-4xl lg:text-5xl font-normal tracking-tight text-white mb-4 group-hover:text-[#F7E7C4] transition-colors uppercase leading-[1.05] sm:leading-[0.95] break-words"
                        style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                      >
                        {project.title}
                      </h3>
                  ...
                  <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-6 lg:pl-6 lg:border-l lg:border-[#8C6D4F]/25">
                    ...
                    {project.githubUrl ? (
                      <a
                        ...
                        className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-6 py-3.5 border border-[#8C6D4F] bg-[#16120E] hover:border-[#D4AF37] hover:bg-[#D4AF37] text-[#EAD8C7] hover:text-black text-[11px] font-medium tracking-[0.24em] uppercase transition-all duration-300 shadow-[0_0_20px_rgba(212,175,55,0.1)]"
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                      >
                      ...
                      <span
                        className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3.5 border border-[#8C6D4F]/30 bg-[#0C0A08] text-[#8C6D4F] text-[10.5px] font-medium tracking-[0.2em] uppercase text-center"
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                      >
                        {project.status}
                      </span>
